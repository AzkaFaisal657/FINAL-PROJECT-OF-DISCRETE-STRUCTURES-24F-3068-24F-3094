...
//    sf::Color headerColor{ 15, 35, 75 };
//    sf::Color cardColor{ 255, 255, 255 };
//    sf::Color primaryBtn{ 25, 85, 165 };
//    sf::Color primaryHover{ 35, 115, 205 };
//    sf::Color secondaryBtn{ 70, 85, 105 };
//    sf::Color secondaryHover{ 95, 115, 140 };
//    sf::Color accentColor{ 0, 150, 136 };
//    sf::Color textDark{ 25, 35, 55 };
//    sf::Color textLight{ 255, 255, 255 };
//    sf::Color textMuted{ 100, 115, 135 };
//    sf::Color successColor{ 40, 180, 100 };
//    sf::Color errorColor{ 220, 60, 60 };
//    sf::Color borderColor{ 200, 215, 230 };
//
...
//    int getCourseCount() { return system->getCourses().size(); }
//    int getStudentCount() { return system->getStudents().size(); }
//    int getFacultyCount() { return system->getFaculty().size(); }
//    int getRoomCount() { return system->getRooms().size(); }
//};
//
//#endif